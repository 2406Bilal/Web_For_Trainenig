<template>
  ...
  <nav class="relative container mx-auto p-6">
    <div class="flex center items-center justify-between">
      ...
      <div>
        <a
          href="#"
          class="p-3 px-6 pt-2 bg-relative container mx-auto bg-brightRed text-white rounded-full baseline hover:bg-brightRedLight md:block"
          >Get Started</a
        >
      </div>
    </div>
  ...
  >
    <div class="flex flex-col mb-32 space-y-12 md:w-1/2">
      <h1
        class="text-4xl font-bold text-left max-w-md md:text-5xl md:text-left"
      >
        Bring everyone together to build better products
      </h1>
      <h1 class="max-w-sm text-darkGrayishBlue text-center md:text-left">
  ...
  <!-- text info -->
  <div
    class="container flex flex-col px-4 mx-auto mt-10 space-y-10 md:space-y-0 md:flex-row"
  >
    <!-- div left -->
    <div class="flex flex-col space-y-12">
      <h1 class="font-bold text-4xl max-w-md text-center md:text-left">
        What's different about Manage?
      </h1>
      <h3 class="max-w-md text-center text-darkGrayishBlue md:text-left">
  ...
  <div class="max-w-6xl px-5 mx-auto mt-32 text-center">
    ...
    <div class="flex flex-col mt-24 md:flex-row md:space-x-6">
      <!-- card1 -->
      <div
        class="flex flex-col items-center space-y-6 rounded-lg bg-veryLightGray md:w-1/3"
      >
        <!-- img -->
        <div class="w-16 -mt-14">
          <img src="./assets/img/avatar-anisha.png" alt="" />
        </div>
        <h1 class="text-lg font-bold">Anisha Li</h1>
      ...
      <!-- card2 -->
      <div
        class="hidden flex-col items-center space-y-6 rounded-lg bg-veryLightGray md:flex md:w-1/3"
      >
        <!-- img -->
        <div class="w-16 -mt-14">
          <img src="./assets/img/avatar-ali.png" alt="" />
        </div>
        <h1 class="text-lg font-bold">Ali Bravo</h1>
        <p class="text-sm text-darkGrayishBlue">
      ...
      >
        <!-- img -->
        <div class="w-16 -mt-14">
          <img src="./assets/img/avatar-richard.png" alt="" />
        </div>
        <h1 class="text-lg font-bold">Richard Watts</h1>
        <p class="text-sm text-darkGrayishBlue">
          “Manage has supercharged our team’s workflow. The ability to maintain
          visibility on larger milestones at all times keeps everyone
          motivated.”
  ...
  <div class="bg-brightRed">
    ...
    >
      <!-- words -->
      <div class="text-5xl font-bold text-center text-white md:text-4xl md:max-w-xl md:text-left">
        <p>Simplify how your team works today</p>
      </div>
      <!-- buttom -->
      <div class="flex justify-center md:justify-start my-16"></div>
      <a
        href="#"
        class="items-center p-3 px-6 pt-2 text-brightRed bg-white rounded-full baseline hover:bg-brightRedLight"
        >Get Started</a
      >
    </div>
  </div>
